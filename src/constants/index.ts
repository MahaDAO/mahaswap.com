...
export const CONTROLLER_ADDRESS: { [chainId in ChainId]: string } = {
  [ChainId.MAINNET]: '0xf4Ae41C9966668fad03F5BFc0c4D7e7239F86e94',
  [ChainId.GÖRLI]: '0xf2e9Eeb38c228c177176F44b0aFF91e4628D9c1B',
  [ChainId.RINKEBY]: '0xb47c55930d705f28ebf98a6d637edda1ab98924d',
  [ChainId.ROPSTEN]: '0x7143733946e70b6789C23CCE96fEC8846f4a2828',
  [ChainId.KOVAN]: '0xb47c55930d705f28ebf98a6d637edda1ab98924d'
}
...
export const MAHA: { [chainId in ChainId]: Token } = {
  ...
  [ChainId.ROPSTEN]: new Token(ChainId.ROPSTEN, '0xcd24efb0f7285cb923cab11a85fbdb1523f10011', 18, 'MAHA', 'MahaDAO'),
...
export const ARTH: { [chainId in ChainId]: Token } = {
  ...
  [ChainId.ROPSTEN]: new Token(ChainId.ROPSTEN, '0x5ac2a32bfa475765558cea2a0fe0bf0207d58ca4', 18, 'ARTH', 'ARTH'),
  [ChainId.KOVAN]: new Token(ChainId.KOVAN, UNI_ADDRESS, 18, 'ARTH', 'ARTH')
}
...
export const DAI: { [chainId in ChainId]: Token } = {
  ...
  [ChainId.ROPSTEN]: new Token(ChainId.ROPSTEN, '0xcd0efae7fa77bfdda4e4997452f3deb06f290a08', 18, 'DAI', 'Dai'),
...
export const BASES_TO_CHECK_TRADES_AGAINST: ChainTokenList = {
  ...WETH_ONLY,
  [ChainId.GÖRLI]: [...WETH_ONLY[ChainId.GÖRLI], DAI[ChainId.GÖRLI], ARTH[ChainId.GÖRLI]],
  [ChainId.MAINNET]: [...WETH_ONLY[ChainId.MAINNET], DAI[ChainId.MAINNET], ARTH[ChainId.MAINNET]]
}
...
export const PINNED_PAIRS: { readonly [chainId in ChainId]?: [Token, Token][] } = {
  [ChainId.MAINNET]: [[DAI[ChainId.MAINNET], ARTH[ChainId.MAINNET]]],
  [ChainId.GÖRLI]: [[DAI[ChainId.GÖRLI], ARTH[ChainId.GÖRLI]]]
}
