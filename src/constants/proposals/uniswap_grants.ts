...
* Each committee has a term of 2 quarters (6 months) after which the program needs to be renewed by MAHA governance
...
Starting with just six members enables the committee to efficiently fund projects with tight feedback loops and rapid iterations. The purpose of this committee would be to test the hypothesis that the Grants Program can successfully provide value for the MAHA ecosystem before scaling the program.
...
**The other 5 committee members should be thought of as “reviewers” — MAHA community members who will keep the grants program functional by ensuring Ken is leading effectively and, of course, not absconding with funds.** Part of the reviewers job is to hold the program accountable for success (defined below) and/or return any excess funds to the MAHA treasury. Reviewers are not compensated as part of this proposal as we expect their time commitment to be minimal. Compensation for the lead role is discussed below, as we expect this to be a labor intensive role.
...
*Founder and Investor at Variant Fund (holds MAHA)*
...
The UGP will be funded by the MAHA treasury according to the[ release schedule](https://uniswap.org/blog/uni/) set out by the Uniswap team, whereby 43% of the MAHA treasury is released over a four-year timeline. In Year 1 this will total to 172,000,000 MAHA (~$344M as of writing).
...
In keeping with the fast pace of the MAHA ecosystem, we organize time in epochs, or two calendar quarters. Each epoch will see two funding rounds, one per quarter, after which the community can review and create proposals to improve or revamp the program as they deem fit.
...
**If this proposal is successfully approved, UGP will start accepting applications on a rolling basis beginning at the start of 2021.** With the phases and priorities laid out above, UGP will aim to make a significant impact by catalyzing growth and innovation in the MAHA ecosystem.
